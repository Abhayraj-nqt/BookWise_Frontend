...
const Issuance = () => {
  ...
  return (
    <div className='issuance-page'>
      ...
      <div className="">
        <Table colums={issuanceCols} data={issuances} currentPage={page} totalPages={totalPages} onPageChange={setPage} sortBy={'Id'} onSort={handleSort} addDelete={true} addEdit={true} onEdit={handleEdit} onDelete={handleDelete} type={'issuance'} />
      </div>
      ...
      <IssuanceFilterPopup title={'Filter issuance'} isPopupOpen={isFilterOpen} closePopup={closeFilter} onFilter={handleFilter} />
    </div>
  )
}
